package com.itravel.api.portal.auth.security.principal;
...
public class AccountPrincipal implements OAuth2User, UserDetails, Serializable {
  ...
  public static AccountPrincipal build(AccountEntity account, Map<String, Object> attributes) {

    AccountPrincipal accountPrincipal = AccountPrincipal.build(account);
  ...
  public String getName() {
    return accountVerified.getFullName();
  }
}
