...
public class SwaggerConfig {
  ...
  private ApiKey apiKey() {
    return new ApiKey(CommonKey.BEARER, CommonKey.AUTHORIZATION, "header");
  }
  ...
  private ApiInfo apiInfo() {
    return new ApiInfoBuilder()
        .title("iTravel Account Portal Service")
        .description("iTravel Account Portal Service API.")
        .version("1.0")
  ...
  public Docket api() {
    return new Docket(DocumentationType.SWAGGER_2)
        ...
        .apis(RequestHandlerSelectors
            .basePackage("com.itravel.api.payment.controller"))
