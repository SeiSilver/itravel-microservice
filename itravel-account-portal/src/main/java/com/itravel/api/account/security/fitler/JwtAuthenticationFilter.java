package com.itravel.api.account.security.fitler;

import com.itravel.api.account.constraint.CommonKey;
import com.itravel.api.account.enums.AccountStatus;
import com.itravel.api.account.exception.AccountLockedException;
import com.itravel.api.account.exception.TokenExpiredException;
import com.itravel.api.account.exception.TokenInvalidException;
import com.itravel.api.account.security.principal.AccountPrincipal;
import com.itravel.api.account.security.service.CustomUserDetailsService;
import com.itravel.api.account.util.JwtUtils;
...
public class JwtAuthenticationFilter extends OncePerRequestFilter {
  ...
  protected void doFilterInternal(HttpServletRequest request, HttpServletResponse response,
    ...
    } catch (AccountLockedException | TokenInvalidException | TokenExpiredException e) {
